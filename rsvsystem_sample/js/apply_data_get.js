...
//classroom_confirm
const classroom_v = sessionStorage.getItem("class_v"); //setから取得した値
const classroom_confirm = document.getElementById('classroom_confirm');
if(name_v == "101"){
    classroom_confirm.innerHTML = '<span>101教室</span>';
}else if(name_v == "102"){
    classroom_confirm.innerHTML = '<span>102教室</span>';
}else if(name_v == "103"){
    classroom_confirm.innerHTML = '<span>103教室</span>';
}else if(name_v == "104"){
    classroom_confirm.innerHTML = '<span>104教室</span>';
}else if(name_v == "201"){
    classroom_confirm.innerHTML = '<span>201教室</span>';
}else if(name_v == "202"){
    classroom_confirm.innerHTML = '<span>202教室</span>';
}else if(name_v == "301"){
    classroom_confirm.innerHTML = '<span>301教室</span>';
}else if(name_v == "302"){
    classroom_confirm.innerHTML = '<span>302教室</span>';
}else if(name_v == "302"){
    classroom_confirm.innerHTML = '<span>303教室</span>';
}
